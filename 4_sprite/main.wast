(module
 ...
 (func $4 (type $4) (param $var$0 i32) (param $var$1 i32) (param $var$2 i32) (param $var$3 i32) (result i32)
  (local $var$4 i32)
  (block $label$0 i32
   (i32.store offset=4
    (i32.const 0)
 ...
 (func $5 (type $5) (param $var$0 f64) (param $var$1 f64) (result f64)
  (local $var$2 i64)
  (local $var$3 i64)
  (block $label$0 f64
   (block $label$1
