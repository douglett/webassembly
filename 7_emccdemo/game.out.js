...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'game.out.wast';
  var wasmBinaryFile = 'game.out.wasm';
  var asmjsCodeFile = 'game.out.temp.asm.js';
